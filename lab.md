...
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin: 30px 0;">
  <img src="/assets/images/UltrasoundExperiment2.jpg" style="width: 100%; max-width: 500px;">
  <img src="/assets/images/ultrasound-optimized.gif" style="width: 100%; max-width: 500px;">
</div>

Speech Behavior and Science Lab（SBS Lab）隸屬於國立臺灣大學語言學研究所，致力於探討語音產製的生理基礎與動態機制，關注人類如何透過身體運動產生語音，並進一步連結語言結構與科技應用。

本實驗室的研究主要涵蓋三個核心領域。首先是「構音動態與生物力學」，我們透過舌部超音波影像等技術觀察語音產製過程中的構音動作，分析不同發音器官之間如何在時間與空間上協調運作，以及物理限制如何形塑語音結構。其次是「語音運動控制」，聚焦於神經系統如何規劃與執行語音動作，特別關注運動準備與快速啟動機制，以理解人類如何高效率地產生複雜語音。第三是「人機語音系統」，結合語音生理與計算模型，發展更具生物基礎的語音科技與互動系統。

在方法上，我們整合多種實驗與建模技術，包括舌部超音波影像分析、發音器官動態追蹤與生理訊號量測，以及以 ArtiSynth 為基礎的生物力學模擬平台，用以重建肌肉、軟組織與聲道的運作。此外，我們也發展以超音波為基礎的生物回饋技術，應用於語音訓練、發音學習與語音復健。

整體而言，SBS Lab 致力於建立一個跨層次的語音研究框架，從生物力學與運動控制出發，延伸至計算模型與實務應用，期望深化對語音行為的理解，並推動語言科技與臨床應用的發展。
